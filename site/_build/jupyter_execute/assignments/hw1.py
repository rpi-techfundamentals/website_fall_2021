...
# YOUR CODE HERE (When you implement the code, delete the following error.)
...
# YOUR CODE HERE (When you implement the code, delete the following raise command.)
raise NotImplementedError()
...
# ## That is it! 
# 
# Please restart the kernel and run everything again, making sure that it runs without errors. 
# 
# Then upload it to LMS. 
