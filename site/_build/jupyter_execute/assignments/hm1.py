...
# 
# Step-2: Open the Jupyter Notebook by first launching the anaconda software console or 
# 
# Step-3: Open the hw1.ipynb file and write your solutions at the appropriate location "# YOUR CODE HERE" (deleting the code `raise NotImplementedError()`).
# 
