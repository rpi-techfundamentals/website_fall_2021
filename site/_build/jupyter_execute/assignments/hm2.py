...
# 
# Step-5: Now go to "File" then click on "Download as" then click on "Notebook (.ipynb)" Please DO NOT change the file name and just keep it as "hw2.ipynb"
# 
...
#### Using groupby operation over `embark_town` and `gender`, assign `var9` as the total number of people survived (`survived` is 1) 
#where they embarked (`embark_town`) at `Southampton` and are female (`gender` is `female`). 
